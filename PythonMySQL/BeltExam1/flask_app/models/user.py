...
class User:
    ...
    def valid_new_user(user):
        ...
        if ( length >= 2 and length <= 16 ):
            ...
            flash("Login name must be at least 2 characters and no more than 16 characters long.", 'warning')
            print("Login name must be at least 2 characters and no more than 16 characters long.", 'warning')
        ############--Password
        length = len(user['password'])
        ...
        if ( length >= 2 and length <= 16 ):
            ...
            flash("First name must be at least 2 characters and no more than 16 characters long.", 'warning')
            print("First name must be at least 2 characters and no more than 16 characters long.", 'warning')
        ##############--LAST NAME
        length = len(user['last_name'])
        if ( length >= 2 and length <= 32 ):
            ...
            flash("Last name must be at least 2 characters and no more than 32 characters long.", 'warning')
            print("Last name must be at least 2 characters and no more than 32 characters long.", 'warning')
        ##############--EMAIL
